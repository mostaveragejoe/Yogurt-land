...
- [ ] **Amend ADR-0005 for the re-roll ruling** — the Combat stream currently derives from `EncounterId` to guarantee identical replay across saves (TR-time-026/027); the 2026-08-24 save-scum ruling requires it to vary per load-and-retry. Owner: technical-director with #18
