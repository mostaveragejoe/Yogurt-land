...
| Design docs written | **3** — Terrain Data Model (Full GDD, **Approved** 2026-08-02); Time Authority / Mode-Switch (Full GDD, **Designed**; third `/design-review` pass now unblocked, see row #2); Pathfinding & Navigation (Quick-spec, **Drafted** 2026-08-20) |
...
| MVP systems designed | **3/25** documented (2 full GDDs + 1 quick-spec). Separately, 2 more MVP systems are **ADR-specified** rather than doc-designed: #4 Seeded RNG (ADR-0005) and #6 Save/Load battle-checkpoint half (ADR-0004) — per the routing policy, ADR-only is a complete tier, not a gap |
...
- [ ] **Quick-spec batch (design order #8–#11)** — Pathfinding & Navigation ✅ **Drafted 2026-08-20** (`design/quick-specs/pathfinding-navigation.md`; tier template at `.claude/docs/templates/quick-spec.md`). Remaining: **Material Catalog** (#9 — blocks on nothing; owns the tier-ordering invariant Terrain hands off, and CD-6's escalating-reward half), **Colonist Entity & Attributes** (#8), **Terrain Rendering & Cutaway** (#11 — folds in the ADR-0002 damage-overlay draw-call open item)
