...
| Design docs written | **5** — Terrain Data Model (Full GDD, **Approved** 2026-08-02); Time Authority / Mode-Switch (Full GDD, **Designed**; third `/design-review` pass now unblocked, see row #2); Pathfinding & Navigation (Quick-spec, **Drafted** 2026-08-24); Material Catalog (Quick-spec, **Drafted** 2026-08-24); Colonist Entity & Attributes (Quick-spec, **Drafted** 2026-08-24) |
...
| MVP systems designed | **5/25** documented (2 full GDDs + 3 quick-specs). Separately, 2 more MVP systems are **ADR-specified** rather than doc-designed: #4 Seeded RNG (ADR-0005) and #6 Save/Load battle-checkpoint half (ADR-0004) — per the routing policy, ADR-only is a complete tier, not a gap |
...
- [ ] **Quick-spec batch (design order #8–#11)** — ✅ Pathfinding & Navigation, ✅ Material Catalog, ✅ Colonist Entity & Attributes all **Drafted 2026-08-24**. Remaining: **Terrain Rendering & Cutaway** (#11 — folds in the ADR-0002 damage-overlay draw-call open item)
