...
- [x] **Amend ADR-0003** — DONE 2026-08-20. Its RealTime composite-walkability formula made a closed door block, contradicting its own bracketed note, its own spike-results section, and criterion 5's 44/44 pass. Corrected at source (*Correction 2026-08-20*); wording only, no re-validation or status change. TurnBased untouched
