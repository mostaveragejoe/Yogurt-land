...
- **Next**: Save/Load quick-spec #6 (now unblocked by ADR-0004 + ADR-0005; the creative-director save-scum ruling should land first); creative-director decision on post-battle time semantics (before Needs & Simulation GDD); target-hardware frame-rate run to promote ADR-0002 and ADR-0004.
