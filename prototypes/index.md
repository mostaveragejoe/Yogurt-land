...
|---|---|---|---|---|
| Save/load spike | 2026-07-26 | Does the whole world survive a round-trip, with derived state rebuilt and combat state absent? | **YES** — 24/24; byte-identical round-trip; a reloaded world evolves identically to one that never left memory; derived state contributes 0 bytes; saves gzip to 2%; MVP autosave 21.9 ms | [SPIKE-NOTE](saveload-spike/SPIKE-NOTE.md) |
...
| Save/load spike | ✅ YES (2026-07-26) — 24/24; ADR-0003 criterion 3 + contract #2 validated. [SPIKE-NOTE](saveload-spike/SPIKE-NOTE.md) |
